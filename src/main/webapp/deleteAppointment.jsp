...
<body>
    ...
    <form action = "delete"  method = "post">
        <fieldset>
            ...
            Customer Name: <input type = "text" name = "cusID"value = "<%=cName%>"readonly> <br><br>
            NIC No : <input type = "text" name = "NIC"value = "<%=cNIC%>"readonly><br><br>
            Doctor ID : <input type = "text" name = "docID"value = "<%=dID%>"readonly > <br><br>
            Doctor's name : <input type = "text" name = "doctorName" value = "<%=dName%>"readonly><br><br>
        
            Requested date : 
            <input type = "text" name = "dateReq" value = <%=reqDate%>readonly><br><br>
            
            Requested time slot : 
            <input type = "text" name = "timeSlot"value = <%=reqTimeSlot%>readonly><br><br>
            
            <input id = "sbmtCreateDelete" type = "submit" name = "submit" value = "Delete Appointment">
        </fieldset>
    </form>
