...
<meta charset="ISO-8859-1">
    <link rel = "stylesheet" href = "assets/css/formsCSS2.css">
    <link rel = "stylesheet" href = "assets/css/formsCSS1.css">
...
<div class="container2"> 
    ...
    <img src = "hp-zdravotnictvi.jpg">
    <form action = "appoint"  method = "post" >
    
    <fieldset>
    
        Enter your Customer ID : <input id = "inputCID" type = "text" name = "cusID"><br><br>
        <input id = "sbmtCID" type = "submit" name = "submit" value = "ENTER">
