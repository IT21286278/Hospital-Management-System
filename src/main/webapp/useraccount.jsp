  ...
  <div class="user-details">
	...
	<div class="input-box">	
     <span class="details">ID:</span>
      <input type="text" name="id"   value="${cus.id}" readonly> <br/><br/>
     </div>
     ...
     <input type="text" name="email"   value="${cus.email}" readonly> <br/><br/>
     </div>
     
     <div class="input-box">	
     <span class="details">Phone:</span>
     <input type="text" name="phone"   value="${cus.phone}" readonly> <br/><br/>
     </div>
     
     <div class="input-box">	
     <span class="details">User name:</span>
	 <input type="text" name="username"   value="${cus.userName}" readonly> <br/><br/>
     </div>
     
     <div class="input-box">	
     <span class="details">Password:</span>
	  <input type="text" name="password"   value="${cus.passWord}" readonly> <br/><br/>
     </div>
	...
	<c:url value="userUpdate.jsp" var="uUpdate">
	...
	<c:url value="userDelete.jsp" var="uDelete">
		<c:param name="id" value="${id}"/>
		<c:param name="name" value="${name}"/>
		<c:param name="email" value="${email}"/>
		<c:param name="phone" value="${phone}"/>
