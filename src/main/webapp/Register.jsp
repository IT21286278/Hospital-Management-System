 ...
 <form action="RegisterUser" method="post">
  ...
  <div class="user-details">
     ...
     <span class="details">Email:</span>
      <input type="email" placeholder="Enter email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required> <br/><br/>
     </div>
     
     
     <div class="input-box">	
     <span class="details">Phone:</span>
      <input type="text" placeholder="Enter phone" name="phone" pattern="[0-9]{10}" required><br> <br/><br/>
     </div>
