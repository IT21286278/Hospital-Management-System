...
<body>
    ...
    <fieldset id = "docDFieldset">
        <h2>Doctor Details</h2>
        <table id = "tble" border="1">
            <c:forEach var = "display" items = "${displayDetails}">
        
            <c:set var = "dID" value = "${doc.dID }"/>
            <c:set var = "dName" value = "${doc.dName }"/>
            <c:set var = "specialization" value = "${doc.specialization }"/>
            <c:set var = "availableDate" value = "${doc.availableDate }"/>
            <c:set var = "availableTimeSlot" value = "${doc.availableTimeSlot }"/>
            ...
            <tr>
                <th><h4>Specialization :</h4></th>
                <td>${doc.cNIC}</td>
            </tr>
            <tr>
                <th><h4>Available date :</h4></th>
                <td>${doc.dID}</td>
            </tr>
            <tr>
                <th><h4>Available hours :</h4></th>
                <td>${doc.dName}</td>
            </tr>
