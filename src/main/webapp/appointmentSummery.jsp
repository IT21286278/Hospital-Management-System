...
<body>
    ...
    <fieldset id = "fieldsetSummery">

        <h2>Appointment Summery</h2>
        <table id = "tble" border = 1>
            <c:forEach var = "appoint" items = "${appointDetails}">
        
            <c:set var = "cID" value = "${cus.cID }"/>
            <c:set var = "cName" value = "${cus.cName }"/>
            <c:set var = "cNIC" value = "${cus.cNIC }"/>
            <c:set var = "dID" value = "${cus.dID }"/>
            <c:set var = "dName" value = "${cus.dName }"/>
            <c:set var = "reqDate" value = "${cus.reqDate }"/>
            <c:set var = "reqTimeSlot" value = "${cus.reqTimeSlot }"/>
            ...
            <tr>
                <th><h4>Requested Date</h4></th>
                <td>${cus.reqDate}</td>
            </tr>
            <tr>
                <th><h4>Requested Time Slot</h4></th>
                <td>${cus.reqTimeSlot}</td>
            </tr>
    
            </c:forEach>
        </table>
    </fieldset>
    <c:url value = "updateAppointment.jsp" var = "appointUpdate">
        <c:param name = "cID" value = "${cID}"/>
        <c:param name = "cName" value = "${cName}"/>
        <c:param name = "cNIC" value = "${cNIC}"/>
        <c:param name = "dID" value = "${dID}"/>
        <c:param name = "dName" value = "${dName}"/>
        <c:param name = "reqDate" value = "${reqDate}"/>
        <c:param name = "reqTimeSlot" value = "${reqTimeSlot}"/>
    </c:url>
        
    <a href = "${appointUpdate}"><input  id = "sbmtUpdateDelete" type ="button" name = "update" value = "Update Appointment"></a>
    
    
    <c:url value = "deleteAppointment.jsp" var = "appointDelete">
    ...
    <a href = "${appointDelete}"><input id = "sbmt" type ="button" name = "delete" value = "Delete Appointment"></a>
    </c:url>
